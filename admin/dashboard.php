                            ...
                            <div class="card p-30">
                                <div class="media">
                                    <div class="media-left meida media-middle">
                                        <span><i class="fa fa-user f-s-40" aria-hidden="true"></i></span>
                                    </div>
                                    <div class="media-body media-text-right">
                                        <h2>
                                        <?php
                                        $stmt = $db->prepare("SELECT COUNT(*) as staff_count FROM staff");
                                        $stmt->execute();
                            ...
                            <div class="card p-30">
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2>
                                        <?php
                                        $stmt = $db->prepare("SELECT COUNT(*) as customer_count FROM customers");
                                        $stmt->execute();
                            ...
                            <div class="card p-30">
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2>
                                        <?php
                                        $stmt = $db->prepare("SELECT COUNT(*) as reservation_count FROM table_reservations");
                                        $stmt->execute();
                            ...
                            <div class="card p-30">
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2>
                                        <?php
                                        $stmt = $db->prepare("SELECT COUNT(*) as message_count FROM contact");
                                        $stmt->execute();
                                        ...
                                        <p class="m-b-0">Contact Messages</p>
                                    </div>
                                </div>
                            </div>
                        </a>
