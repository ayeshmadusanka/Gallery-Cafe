...
<head>
    ...
    <title>Gallery Cafe | Contact Submissions</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">List of all contact messages</h6>
                                            ...
                                            if (mysqli_num_rows($query) > 0) {
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    echo '<tr>
                                                            ...
                                                            <td>' . $rows['submitted_at'] . '</td>
                                                        </tr>';
                                                }
                                            } else {
                                                echo '<tr><td colspan="6"><center>No Submissions Found</center></td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
    ...
    <script>
      $(document).ready(function() {
        $('#example234').DataTable({
            "order": [
                [5, 'desc']  // Order by the Date Submitted column in descending order
            ],
            dom: 'Bfrtip',
            buttons: [
